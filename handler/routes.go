...
func (h *Handler) Register(v1 *echo.Group) {
	...
	deposit.POST("/:e", h.CreateDeposit, customJWTMiddleware)
	deposit.GET("/:e/:id", h.GetDeposit, customJWTMiddleware)
	deposit.GET("/:e/created", h.GetDepositCreated, customJWTMiddleware)
	deposit.GET("/:e/uploaded", h.GetDepositUploaded, customJWTMiddleware)
	deposit.GET("/:e/done", h.GetDepositDone, customJWTMiddleware)
	deposit.GET("/:e/all", h.GetAllDeposit, customJWTMiddleware)
	deposit.GET("/:e/image/:id", h.GetImage)
	deposit.POST("/:e/update/:id", h.UpdateDeposit, customJWTMiddleware)
	deposit.GET("/:e/delete/:id", h.CancelDeposit, customJWTMiddleware)
